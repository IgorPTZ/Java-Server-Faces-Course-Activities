...
public class NewPendenciesFlowBuilder implements Serializable {
    ...
    public Flow  defineFlow(@FlowBuilderParameter FlowBuilder flowBuilder) {
      ...
      flowBuilder.inboundParameter("nomeUsuario", "#{testeFlowBuilderNestedBean.nomeUsuario}");
      flowBuilder.inboundParameter("sobrenomeUsuario", "#{testeFlowBuilderNestedBean.sobrenomeUsuario}");
